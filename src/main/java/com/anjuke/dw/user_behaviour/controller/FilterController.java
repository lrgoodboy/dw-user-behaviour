...
public class FilterController {
    ...
    public String index(ModelMap model,
        ...
        actionLogDao.findByFilters(date, os, version, channel, null, null, count);
        ...
        String versions = "7.2,7.1.1,7.1,7.0.1,7.0,6.2.2,6.2.1,6.2,6.1.1,6.1,ver6.0,5.3.1,5.3,5.2.1,5.2,5.1.2,5.1.1,5.1,5.0.1,5.0,4.6.3,4.6.2,4.6.1,4.6,4.5,4.4,4.1.2,4.1.1,4.1,4.0,3.7.3,3.7.2,3.7.1,3.7,3.6.1,3.6,3.5.1,3.4.1,3.3.1,3.2.2,3.2.1,3.2,3.1.3,3.1,3.0.1,3.0,2.1.2,2.0.3,2.0.2,2.0.1,2.0,1.2,1.1.1,1.1,1.0.1";
